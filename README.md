...
> Status: npm 0.8.0 uses Nayori's verified v5/v4 contracts as the
...
**0.8.0 is the reviewed stable SDK line.** Pin the exact version and verify registry integrity.
See [release notes and exact installation](docs/RELEASE_0.8.0.md).
The [rc.1 release record](docs/RELEASE_0.8.0_RC1.md) remains available for historical reproduction.
The stable SDK preserves default v5/v4 contracts; its delegated custody pilot is testnet-only.
...
stays in escrow until final settlement. The methods ship in 0.8.0, while the candidate
...
Version `0.8.0` selects Nayori's source-verified v5/v4/v3 generation by default on mainnet and
