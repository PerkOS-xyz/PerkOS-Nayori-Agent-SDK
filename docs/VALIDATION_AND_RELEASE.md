...
| --- | --- |
| npm `@perkos/agent-sdk@0.9.1` | Stable line (`latest`, published 2026-09-13): mainnet v6/v5 defaults, explicit earned-fee consent and x402 fee-term binding; production consumer rollout remains a separate event |
