...
describe("Nayori v1 wire commitments", () => {
  ...
  it("has a stable mainnet cross-repository fixture", async () => {
    ...
    expect(await evaluationJobId({ network: "mainnet", contract: mainnetInput.contract, jobId: mainnetInput.jobId }))
