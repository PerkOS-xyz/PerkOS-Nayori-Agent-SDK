...
**Stable SDK 0.8.0; job16 npm lifecycle verified, fresh registration/video separate.**
...
Follow [MCP client setup](MCP_CLIENTS.md) with pinned npm 0.8.0 and its registry integrity. Create,
